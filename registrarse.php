...
require_once('header.php');
	if(isset($_POST['nombre']) 
		...
		if(($contrasena == $contrasena2) && (strlen($contrasena >= 6))){
			...
			$insertar = mysqli_query($conexion, "INSERT INTO usuarios (nombre, apellido, email, contrasena) VALUES ('$nombre', '$apellido', '$email', '$contrasena_encriptada')");
			?>
			...
			<div class="alert alert-danger">
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
				<strong>Error!</strong> Las contraseñas son incorrectas ...
			</div>
			<?php
		}
	}
	...
	<div class="col-md-offset-3 col-md-6">
		<form action="" method="POST" role="form">
			...
			<div class="form-group">
				...
				<input type="email" class="form-control" name="email" placeholder="Ingrese Correo Electrónico" required="">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="password" class="form-control" name="contrasena2" placeholder="Ingrese Contraseña Otra Vez" required="">
			</div>
